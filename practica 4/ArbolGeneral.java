...
public class ArbolGeneral<T> {
	...
	//ejercicio6
	/*private void esAncestro(T a, T b, Boolean ab, Boolean bb) {
		
		ListaGenerica<ArbolGeneral<T>> lHijos = this.getHijos();
		lHijos.comenzar();
		
		if(!ab && !bb) {
			System.out.println("encontre a:" +ab);
			System.out.println("encontre b:" +bb);
			System.out.println(this.getDato());
			if(this.getDato().equals(a)) 
				ab = true;
			while(!lHijos.fin()) {
				lHijos.proximo().esAncestro(a,b,ab,bb);
			}
		}else if(!bb){
			System.out.println("encontre a:" +ab);
			System.out.println("encontre b:" +bb);
	...
	public Boolean esAncestro(T a, T b) {
		{
	        ...
	        // no comparamos i <= tamaño pq esa es la raiz, osea A
